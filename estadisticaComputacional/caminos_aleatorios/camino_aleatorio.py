from aleatoriedad import BorrachoTradicional
from aleatoriedad_campo import Campo
from aleatoriedad_coordenada import Coordenada
...
def simular_caminata(pasos, numero_de_intentos, tipo_de_borracho):
    borracho = tipo_de_borracho(name = 'Pepe')
